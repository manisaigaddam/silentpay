    ...
    <main className="center-screen">
      <div className="panel receipt-card">
        ...
        <div className="detail-list">
          <p><span>Recipient</span><strong>{receipt.merchantName}</strong></p>
          <p><span>Payer</span><strong>{receipt.payerLabel}</strong></p>
          <p><span>Receiving wallet</span><strong>{shortAddress(receipt.merchantAddress)}</strong></p>
        ...
        <p className="muted-text">
          Receipt details stay readable through this private receipt link. Public chain data only carries transaction metadata and ciphertext.
        </p>
